...
export const TableCellWithBorder = styled(TableCell)(
  ({
    ...
    borderLeft: isBorderLeft ? '1px solid #DFE0EB' : 'none',
    borderRight: isBorderRight ? '1px solid #DFE0EB' : 'none',
    borderBottom: isBorderBottom ? '1px solid #DFE0EB' : 'none',
    borderTop: isBorderTop ? '1px solid #DFE0EB' : 'none',
  })
)
